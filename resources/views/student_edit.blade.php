            ...
            <div class="col-12 text-center pt-5">
                ...
                <form id="edit-frm" method="POST" action="{{ route('update', $student->id) }}" class="border p-3 mt-2">
                    <div class="control-group col-6 text-left">
                        ...
                        <div>
                            <input type="text" id="fullname" class="form-control mb-4" name="fullname"
                                placeholder="Enter Fullname" value="{{ $student->fullname }}"
                                required>
                        </div>
                    </div>
                    <div class="control-group col-6 mt-2 text-left">
                        ...
                        <div>
                            <input type="date" id="price" class="form-control mb-4" name="birthday"
                                placeholder="Enter birthday" value="{{ date("m/d/Y", strtotime($student->birthday)) }}"
                                required>
                        </div>
                    </div>
                    <div class="control-group col-6 mt-2 text-left">
                        <label for="Address">Address</label>rm -fr .git
                        <div>
